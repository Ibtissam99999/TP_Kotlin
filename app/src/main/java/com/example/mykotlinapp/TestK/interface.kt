...
// Classe Formateur qui hérite de Personne et implémente

class Formateure(nom: String, age: Int, val specialite:
String) : Personne(nom, age), Enseignable {
...
// Classe Stagiaire qui hérite de Personne et implémente

class Stagiaire(nom: String, age: Int, val niveau: String)
    : Personne(nom, age), Enseignable {
    override fun afficherDetails() {
...
fun main() {
    val formateur = Formateure("John Doe", 35, "Développement Mobile")
